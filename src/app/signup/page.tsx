...
import { Hourglass, Sparkles, UserPlus } from "lucide-react"
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 mesa-viva-bg bg-fixed">
      ...
      <div className="relative z-10 w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <h1 className="text-4xl font-display font-black tracking-tighter">Cronofábula</h1>
        ...
        <Card className="bg-card/80 border-white/10 backdrop-blur-xl literary-shadow">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="Como quer ser chamado?" className="bg-background/50 border-white/10" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="email" className="font-ui uppercase text-[10px] tracking-widest font-bold">E-mail</Label>
              <Input id="email" type="email" placeholder="aventureiro@cronofabula.com" className="bg-background/50 border-white/10" />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Input id="confirm-password" type="password" className="bg-background/50 border-white/10" />
            </div>
            
            <Button asChild className="w-full bg-accent hover:bg-accent/90 text-accent-foreground h-12 text-lg font-display tracking-tight mt-6">
